...
| Inventory | `com.arcanaerp.platform.inventory` | On-hand inventory lookup and adjustment transactions by SKU | `InventoryAvailability` | `GET /api/inventory/{sku}`, `POST /api/inventory/{sku}/adjustments` |
