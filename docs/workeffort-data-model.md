...
Purpose:
- mirror legacy `work_requirement_fulfillment` records linking work efforts to requirements
- track the work effort that fulfills a requirement without adding Requirement module behavior
