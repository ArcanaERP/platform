...
final class CommunicationEventsDeterministicClockTestSupport {

    static final Instant BASE_TEST_INSTANT = Instant.parse("2027-07-01T00:00:00Z");

    private CommunicationEventsDeterministicClockTestSupport() {}
    ...
    static class Configuration {
        ...
        @Bean
        @Primary
        AdjustableClock communicationEventsTestClock() {
