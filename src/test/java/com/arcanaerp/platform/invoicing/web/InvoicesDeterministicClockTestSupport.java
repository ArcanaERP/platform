...
final class InvoicesDeterministicClockTestSupport {

    static final Instant BASE_TEST_INSTANT = Instant.parse("2026-03-11T00:00:00Z");

    private InvoicesDeterministicClockTestSupport() {}
    ...
    static class Configuration {
        ...
        @Bean
        @Primary
        AdjustableClock invoicesTestClock() {
