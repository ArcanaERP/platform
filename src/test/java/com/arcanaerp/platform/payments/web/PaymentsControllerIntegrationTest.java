...
class PaymentsControllerIntegrationTest {
    ...
    private static final String COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_SUMMARY_TENANT_CODE = "tenant-coll-fup-outactor";
    private static final String COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_DAILY_SUMMARY_TENANT_CODE = "tenant-coll-fup-outactday";
    private static final String COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE = "tenant-coll-fup-outactwk";
    private static final String COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_MONTHLY_SUMMARY_TENANT_CODE = "tenant-coll-fup-outactmo";
    ...
    private static final String COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_MONTHLY_SUMMARY_TENANT_CODE = "tenant-coll-asseffmonth";
    ...
    private static final String COLLECTIONS_ASSIGNEE_DASHBOARD_MONTHLY_SUMMARY_TENANT_CODE = "tenant-coll-assdashmo";
    ...
    @Test
    void listsTenantCollectionsActorFollowUpOutcomeSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_SUMMARY_TENANT_CODE,
            "Collections Follow Up Outcome Actor Summary Tenant",
            "COLLECTOR",
            "Collector",
            "collector@arcanaerp.com",
            "Collector"
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsActorFollowUpOutcomeSummaryRequest(
                COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_SUMMARY_TENANT_CODE,
                0,
                10,
                "changedAtFrom", assignedAt.plusSeconds(2 * 86400).toString(),
            ...
            .andExpect(jsonPath("$.items[1].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[1].completionCount").value(2))
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsActorFollowUpOutcomeSummaryRequest(
            ...
            .andExpect(jsonPath("$.items[0].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[0].completionCount").value(2))
    ...
    @Test
    void listsDailyTenantCollectionsActorFollowUpOutcomeSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
        ...
        Instant firstCompletionAt = assignedAt.plusSeconds(2 * 86400);
        testClock.setInstant(firstCompletionAt);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_DAILY_SUMMARY_TENANT_CODE,
            "inv-pay-9940",
        ...
        Instant secondCompletionAt = assignedAt.plusSeconds(3 * 86400);
        testClock.setInstant(secondCompletionAt);
        PaymentsWebIntegrationTestSupport.scheduleCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_DAILY_SUMMARY_TENANT_CODE,
            "inv-pay-9942",
            secondCompletionAt.plusSeconds(3600),
            "manager@arcanaerp.com"
        ).andExpect(status().isOk());
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.dailyTenantCollectionsActorFollowUpOutcomeSummaryRequest(
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(3))
            .andExpect(jsonPath("$.items[0].businessDate").value(secondCompletionAt.atOffset(java.time.ZoneOffset.UTC).toLocalDate().toString()))
            .andExpect(jsonPath("$.items[0].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[0].completionCount").value(1))
            .andExpect(jsonPath("$.items[0].invoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessDate").value(firstCompletionAt.atOffset(java.time.ZoneOffset.UTC).toLocalDate().toString()))
            ...
            .andExpect(jsonPath("$.items[1].completionCount").value(1))
            .andExpect(jsonPath("$.items[1].invoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].businessDate").value(firstCompletionAt.atOffset(java.time.ZoneOffset.UTC).toLocalDate().toString()))
            .andExpect(jsonPath("$.items[2].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[2].completionCount").value(1))
            .andExpect(jsonPath("$.items[2].invoiceCount").value(1));
    ...
    @Test
    void listsWeeklyTenantCollectionsActorFollowUpOutcomeSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE,
            "Collections Follow Up Outcome Actor Weekly Summary Tenant",
            "COLLECTOR",
            "Collector",
            "collector@arcanaerp.com",
            "Collector"
        ...
        PaymentsWebIntegrationTestSupport.scheduleCollectionsFollowUp(
            ...
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE,
            "inv-pay-9952",
            firstScheduledAt.plusSeconds(120),
            "manager@arcanaerp.com"
        ).andExpect(status().isOk());

        Instant firstCompletionAt = assignedAt.plusSeconds(2 * 86400).plusSeconds(10 * 3600);
        testClock.setInstant(firstCompletionAt);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE,
        ...
        Instant secondScheduledAt = firstCompletionAt.plusSeconds(7 * 86400);
        testClock.setInstant(secondScheduledAt);
        PaymentsWebIntegrationTestSupport.scheduleCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE,
            "inv-pay-9952",
            secondScheduledAt.plusSeconds(3600),
            "manager@arcanaerp.com"
        ).andExpect(status().isOk());

        Instant secondCompletionAt = firstCompletionAt.plusSeconds(7 * 86400).plusSeconds(3600);
        testClock.setInstant(secondCompletionAt);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_WEEKLY_SUMMARY_TENANT_CODE,
        ...
        String firstWeekStart = firstCompletionAt.atOffset(java.time.ZoneOffset.UTC)
            .toLocalDate()
            .with(java.time.temporal.TemporalAdjusters.previousOrSame(java.time.DayOfWeek.MONDAY))
            .toString();
        String secondWeekStart = secondCompletionAt.atOffset(java.time.ZoneOffset.UTC)
            .toLocalDate()
            .with(java.time.temporal.TemporalAdjusters.previousOrSame(java.time.DayOfWeek.MONDAY))
            .toString();
    ...
    @Test
    void listsMonthlyTenantCollectionsActorFollowUpOutcomeSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_MONTHLY_SUMMARY_TENANT_CODE,
            "Collections Follow Up Outcome Actor Monthly Summary Tenant",
            "COLLECTOR",
            "Collector",
            "collector@arcanaerp.com",
            "Collector"
        ...
        Instant firstCompletionAt = Instant.parse("2026-07-09T10:00:00Z");
        testClock.setInstant(firstCompletionAt);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_MONTHLY_SUMMARY_TENANT_CODE,
        ...
        Instant secondScheduledAt = firstCompletionAt.plusSeconds(31 * 86400);
        testClock.setInstant(secondScheduledAt);
        PaymentsWebIntegrationTestSupport.scheduleCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_MONTHLY_SUMMARY_TENANT_CODE,
        ...
        Instant secondCompletionAt = Instant.parse("2026-08-10T11:00:00Z");
        testClock.setInstant(secondCompletionAt);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_FOLLOW_UP_OUTCOME_ACTOR_MONTHLY_SUMMARY_TENANT_CODE,
        ...
        String firstMonth = java.time.YearMonth.from(firstCompletionAt.atOffset(java.time.ZoneOffset.UTC)).toString();
        String secondMonth = java.time.YearMonth.from(secondCompletionAt.atOffset(java.time.ZoneOffset.UTC)).toString();
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.monthlyTenantCollectionsActorFollowUpOutcomeSummaryRequest(
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(3))
            .andExpect(jsonPath("$.items[0].businessMonth").value(secondMonth))
            .andExpect(jsonPath("$.items[0].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[0].completionCount").value(1))
            .andExpect(jsonPath("$.items[0].invoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessMonth").value(firstMonth))
            .andExpect(jsonPath("$.items[1].changedBy").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].outcome").value("PROMISE_TO_PAY"))
            .andExpect(jsonPath("$.items[1].completionCount").value(1))
            .andExpect(jsonPath("$.items[1].invoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].businessMonth").value(firstMonth))
            .andExpect(jsonPath("$.items[2].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].outcome").value("NO_RESPONSE"))
            .andExpect(jsonPath("$.items[2].completionCount").value(1))
            .andExpect(jsonPath("$.items[2].invoiceCount").value(1));
    ...
    @Test
    void listsTenantCollectionsAssigneeActorEffectivenessSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_SUMMARY_TENANT_CODE,
            "Collections Assignee Actor Effectiveness Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsAssigneeActorEffectivenessSummaryRequest(
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(3))
            .andExpect(jsonPath("$.items[0].tenantCode").value("TENANT-COLL-ASSEFF"))
            .andExpect(jsonPath("$.items[0].currencyCode").value("USD"))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].changedBy").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].currentAssignedInvoiceCount").value(2))
            ...
            .andExpect(jsonPath("$.items[1].completionCount").value(1))
            .andExpect(jsonPath("$.items[1].completedInvoiceCount").value(1))
            ...
            .andExpect(jsonPath("$.items[2].currentAssignedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].currentOutstandingAmount").value(10.00))
            .andExpect(jsonPath("$.items[2].completionCount").value(0))
            .andExpect(jsonPath("$.items[2].completedInvoiceCount").value(0));
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsAssigneeActorEffectivenessSummaryRequest(
                ...
                0,
                10,
                "sortBy", "completed_invoice_count",
                "changedAtFrom", completedAt.minusSeconds(1).toString(),
                "changedAtTo", completedAt.plusSeconds(1).toString()
            ))
            .andExpect(status().isOk())
    ...
    @Test
    void listsDailyTenantCollectionsAssigneeActorEffectivenessSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_DAILY_SUMMARY_TENANT_CODE,
            "Collections Assignee Actor Effectiveness Daily Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        Instant firstDay = assignedAt.plusSeconds(2 * 86400);
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.dailyTenantCollectionsAssigneeActorEffectivenessSummaryRequest(
                COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_DAILY_SUMMARY_TENANT_CODE,
                "USD",
                0,
                10,
                "changedAtFrom", firstDay.minusSeconds(1).toString(),
                "changedAtTo", secondDay.plusSeconds(1).toString()
            ))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(3))
    ...
    @Test
    void listsMonthlyTenantCollectionsAssigneeActorEffectivenessSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_MONTHLY_SUMMARY_TENANT_CODE,
            "Collections Assignee Actor Effectiveness Monthly Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        Instant firstMonth = Instant.parse("2026-08-15T09:00:00Z");
        ...
        Instant secondMonth = Instant.parse("2026-09-15T09:00:00Z");
        ...
        YearMonth firstBusinessMonth = YearMonth.from(firstMonth.atOffset(java.time.ZoneOffset.UTC));
        YearMonth secondBusinessMonth = YearMonth.from(secondMonth.atOffset(java.time.ZoneOffset.UTC));

        mockMvc.perform(PaymentsWebIntegrationTestSupport.monthlyTenantCollectionsAssigneeActorEffectivenessSummaryRequest(
                COLLECTIONS_ASSIGNEE_ACTOR_EFFECTIVENESS_MONTHLY_SUMMARY_TENANT_CODE,
                "USD",
                0,
                10,
                "changedAtFrom", firstMonth.minusSeconds(1).toString(),
                "changedAtTo", secondMonth.plusSeconds(1).toString()
            ))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(3))
            .andExpect(jsonPath("$.items[0].businessMonth").value(secondBusinessMonth.toString()))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].currentAssignedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[0].completionCount").value(1))
            .andExpect(jsonPath("$.items[0].completedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessMonth").value(firstBusinessMonth.toString()))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].changedBy").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].currentAssignedInvoiceCount").value(2))
            .andExpect(jsonPath("$.items[1].completionCount").value(1))
            .andExpect(jsonPath("$.items[2].businessMonth").value(firstBusinessMonth.toString()))
            .andExpect(jsonPath("$.items[2].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].completionCount").value(1));
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.monthlyTenantCollectionsAssigneeActorEffectivenessSummaryRequest(
            ...
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].changedBy").value("manager@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].businessMonth").value(firstBusinessMonth.toString()));
    }

    @Test
    void listsTenantCollectionsAssigneeDashboardSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_SUMMARY_TENANT_CODE,
            "Collections Assignee Dashboard Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsAssigneeDashboardSummaryRequest(
            ...
            .andExpect(jsonPath("$.items[0].noRecordedOutcomeInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[0].promiseToPayInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[0].noResponseInvoiceCount").value(0))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].assignedInvoiceCount").value(4))
            .andExpect(jsonPath("$.items[1].contactedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].leftVoicemailInvoiceCount").value(1))
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsAssigneeDashboardSummaryRequest(
            ...
            .andExpect(jsonPath("$.totalItems").value(2))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].assignedInvoiceCount").value(4))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-a@arcanaerp.com"))
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.tenantCollectionsAssigneeDashboardSummaryRequest(
                ...
                10,
                "sortBy",
                "left_voicemail_invoice_count"
            ))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(2))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].leftVoicemailInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].leftVoicemailInvoiceCount").value(0));
    ...
    @Test
    void listsDailyTenantCollectionsAssigneeDashboardSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_DAILY_SUMMARY_TENANT_CODE,
            "Collections Assignee Dashboard Day Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.dailyTenantCollectionsAssigneeDashboardSummaryRequest(
            ...
            .andExpect(jsonPath("$.items[0].businessDate").value(secondDay.toString().substring(0, 10)))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].completionCount").value(1))
            .andExpect(jsonPath("$.items[0].contactedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessDate").value(secondDay.toString().substring(0, 10)))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].leftVoicemailInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].businessDate").value(firstDay.toString().substring(0, 10)))
            .andExpect(jsonPath("$.items[2].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].promiseToPayInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[3].businessDate").value(firstDay.toString().substring(0, 10)))
    ...
    @Test
    void listsWeeklyTenantCollectionsAssigneeDashboardSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_WEEKLY_SUMMARY_TENANT_CODE,
            "Collections Assignee Dashboard Week Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        String firstWeekStart = firstWeek.minusSeconds(2 * 86400).toString().substring(0, 10);
        String secondWeekStart = secondWeek.minusSeconds(2 * 86400).toString().substring(0, 10);
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.weeklyTenantCollectionsAssigneeDashboardSummaryRequest(
            ...
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].contactedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessWeekStart").value(secondWeekStart))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].leftVoicemailInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].businessWeekStart").value(firstWeekStart))
            .andExpect(jsonPath("$.items[2].assignedTo").value("collector-a@arcanaerp.com"))
    ...
    @Test
    void listsMonthlyTenantCollectionsAssigneeDashboardSummaries() throws Exception {
        PaymentsWebIntegrationTestSupport.createIdentityUser(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_MONTHLY_SUMMARY_TENANT_CODE,
            "Collections Assignee Dashboard Month Tenant",
            "COLLECTOR_A",
            "Collector A",
            "collector-a@arcanaerp.com",
            "Collector A"
        ...
        Instant firstMonth = assignedAt.plusSeconds(2 * 86400);
        testClock.setInstant(firstMonth);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_MONTHLY_SUMMARY_TENANT_CODE,
        ...
        Instant secondMonth = firstMonth.plusSeconds(32 * 86400);
        testClock.setInstant(secondMonth);
        PaymentsWebIntegrationTestSupport.completeCollectionsFollowUp(
            mockMvc,
            COLLECTIONS_ASSIGNEE_DASHBOARD_MONTHLY_SUMMARY_TENANT_CODE,
        ...
        String firstMonthValue = YearMonth.from(firstMonth.atOffset(java.time.ZoneOffset.UTC)).toString();
        String secondMonthValue = YearMonth.from(secondMonth.atOffset(java.time.ZoneOffset.UTC)).toString();
        ...
        mockMvc.perform(PaymentsWebIntegrationTestSupport.monthlyTenantCollectionsAssigneeDashboardSummaryRequest(
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.totalItems").value(4))
            .andExpect(jsonPath("$.items[0].businessMonth").value(secondMonthValue))
            .andExpect(jsonPath("$.items[0].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[0].contactedInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[1].businessMonth").value(secondMonthValue))
            .andExpect(jsonPath("$.items[1].assignedTo").value("collector-b@arcanaerp.com"))
            .andExpect(jsonPath("$.items[1].leftVoicemailInvoiceCount").value(1))
            .andExpect(jsonPath("$.items[2].businessMonth").value(firstMonthValue))
            .andExpect(jsonPath("$.items[2].assignedTo").value("collector-a@arcanaerp.com"))
            .andExpect(jsonPath("$.items[2].promiseToPayInvoiceCount").value(1))
    ...
    @Test
    void rejectsInvalidSortByForOver90TenantCollectionsAssignmentSummary() throws Exception {
        mockMvc.perform(PaymentsWebIntegrationTestSupport.over90TenantCollectionsAssignmentSummaryRequest(
                COLLECTIONS_OVER90_ASSIGNEE_SUMMARY_TENANT_CODE,
                "USD",
                0,
