...
final class PaymentsWebIntegrationTestSupport {
    ...
    static MockHttpServletRequestBuilder weeklyTenantCollectionsAssigneeActorEffectivenessSummaryRequest(
        String tenantCode,
        String currencyCode,
        Integer page,
        Integer size,
        ...
        MockHttpServletRequestBuilder request = get(
            "/api/payments/tenants/" + tenantCode + "/receivables/collections/assignee-actor-effectiveness/weekly-summary"
        ).param("currencyCode", currencyCode);
        if (page != null) {
            request.param("page", String.valueOf(page));
        }
    ...
    static MockHttpServletRequestBuilder monthlyTenantCollectionsAssigneeActorEffectivenessSummaryRequest(
        String tenantCode,
        String currencyCode,
        Integer page,
        Integer size,
        ...
        MockHttpServletRequestBuilder request = get(
            "/api/payments/tenants/" + tenantCode + "/receivables/collections/assignee-actor-effectiveness/monthly-summary"
        ).param("currencyCode", currencyCode);
        if (page != null) {
            request.param("page", String.valueOf(page));
        }
