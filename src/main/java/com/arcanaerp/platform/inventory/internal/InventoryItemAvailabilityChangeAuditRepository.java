...
interface InventoryItemAvailabilityChangeAuditRepository
    extends JpaRepository<InventoryItemAvailabilityChangeAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryItemAvailabilityChangeAudit audit
    ...
    Page<InventoryItemAvailabilityChangeAudit> findHistoryFiltered(
