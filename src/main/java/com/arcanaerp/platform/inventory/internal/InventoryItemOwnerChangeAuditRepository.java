...
interface InventoryItemOwnerChangeAuditRepository extends JpaRepository<InventoryItemOwnerChangeAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryItemOwnerChangeAudit audit
    ...
    Page<InventoryItemOwnerChangeAudit> findHistoryFiltered(
