...
interface InventoryFacilityPartyRoleAssignmentEndAuditRepository
    extends JpaRepository<InventoryFacilityPartyRoleAssignmentEndAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryFacilityPartyRoleAssignmentEndAudit audit
    ...
    Page<InventoryFacilityPartyRoleAssignmentEndAudit> findHistoryFiltered(
