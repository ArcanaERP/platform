...
interface InventoryStorageAreaMetadataChangeAuditRepository
    extends JpaRepository<InventoryStorageAreaMetadataChangeAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryStorageAreaMetadataChangeAudit audit
    ...
    Page<InventoryStorageAreaMetadataChangeAudit> findHistoryFiltered(
