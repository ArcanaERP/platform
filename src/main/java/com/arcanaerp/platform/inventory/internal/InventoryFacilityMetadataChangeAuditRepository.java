...
interface InventoryFacilityMetadataChangeAuditRepository
    extends JpaRepository<InventoryFacilityMetadataChangeAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryFacilityMetadataChangeAudit audit
    ...
    Page<InventoryFacilityMetadataChangeAudit> findHistoryFiltered(
