...
interface InventoryLocationTypeMetadataChangeAuditRepository
    extends JpaRepository<InventoryLocationTypeMetadataChangeAudit, UUID> {

    @Query(
        """
        select audit
        from InventoryLocationTypeMetadataChangeAudit audit
    ...
    Page<InventoryLocationTypeMetadataChangeAudit> findHistoryFiltered(
