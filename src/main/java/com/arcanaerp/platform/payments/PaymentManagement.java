...
public interface PaymentManagement {
    ...
    PageResult<TenantCollectionsAssigneeOperationsSummaryView> listTenantCollectionsAssigneeOperationsSummaries(
        String tenantCode,
        String currencyCode,
        String actor,
        Instant changedAtFrom,
    ...
    PageResult<TenantCollectionsAssigneeActorEffectivenessSummaryView> listTenantCollectionsAssigneeActorEffectivenessSummaries(
        String tenantCode,
        String currencyCode,
        String assignedTo,
        String changedBy,
    ...
    PageResult<DailyTenantCollectionsAssigneeActorEffectivenessSummaryView>
    ...
    PageResult<WeeklyTenantCollectionsAssigneeActorEffectivenessSummaryView>
    ...
    PageResult<MonthlyTenantCollectionsNetIntakeSummaryView> listMonthlyTenantCollectionsNetIntakeSummaries(
        String tenantCode,
        String actor,
        Instant changedAtFrom,
        Instant changedAtTo,
    ...
    PageResult<WeeklyTenantCollectionsAssigneeDashboardSummaryView> listWeeklyTenantCollectionsAssigneeDashboardSummaries(
        String tenantCode,
        String assignedTo,
        String changedBy,
        CollectionsFollowUpOutcome outcome,
    ...
    PageResult<MonthlyTenantCollectionsAssigneeDashboardSummaryView> listMonthlyTenantCollectionsAssigneeDashboardSummaries(
        String tenantCode,
        String assignedTo,
        String changedBy,
        CollectionsFollowUpOutcome outcome,
    ...
    PageResult<TenantCollectionsActorFollowUpOutcomeSummaryView> listTenantCollectionsActorFollowUpOutcomeSummaries(
        String tenantCode,
        CollectionsFollowUpOutcome outcome,
        String changedBy,
        Instant changedAtFrom,
    ...
    PageResult<DailyTenantCollectionsActorFollowUpOutcomeSummaryView> listDailyTenantCollectionsActorFollowUpOutcomeSummaries(
        String tenantCode,
        CollectionsFollowUpOutcome outcome,
        String changedBy,
        Instant changedAtFrom,
    ...
    PageResult<WeeklyTenantCollectionsActorFollowUpOutcomeSummaryView> listWeeklyTenantCollectionsActorFollowUpOutcomeSummaries(
        String tenantCode,
        CollectionsFollowUpOutcome outcome,
        String changedBy,
        Instant changedAtFrom,
    ...
    PageResult<MonthlyTenantCollectionsActorFollowUpOutcomeSummaryView> listMonthlyTenantCollectionsActorFollowUpOutcomeSummaries(
        String tenantCode,
        CollectionsFollowUpOutcome outcome,
        String changedBy,
        Instant changedAtFrom,
